...
const About = () => {
  return (
    <section id="about">
      ...
      <iframe title="TypeRacer Video Walkthrough" src="https://www.youtube.com/embed/9znLhbkV1Gs" allow="autoplay; encrypted-media" allowfullscreen="" width="560" height="315" frameborder="0"></iframe>
